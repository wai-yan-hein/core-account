 ...
 */
@Slf4j
public final class SizeAutoCompleter implements KeyListener {

    private final JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private final DespTableModel despModel = new DespTableModel("Size");
    ...
    public SizeAutoCompleter() {
    }

    public SizeAutoCompleter(JTextComponent comp, InventoryRepo accountRepo,
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SizeAutoCompleter completer = (SizeAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
