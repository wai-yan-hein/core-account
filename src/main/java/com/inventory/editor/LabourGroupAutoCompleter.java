 ...
 * @author Lenovo
 */
public final class LabourGroupAutoCompleter implements KeyListener {
    ...
    private LabourGroup type;
    public AbstractCellEditor editor;
    private TableRowSorter<TableModel> sorter;
    private int x = 0;
    private int y = 0;
    private SelectionObserver observer;
    private List<LabourGroup> listStockType;
    private boolean filter;

    public List<LabourGroup> getListStockType() {
    ...
    public void setListObject(List<LabourGroup> list) {
        if (filter) {
            LabourGroup st = new LabourGroup("-", "All");
            list.add(0, st);
            setObject(st);
        }
    ...
    public LabourGroupAutoCompleter() {
    }

    public LabourGroupAutoCompleter(JTextComponent comp,
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            ...
            if (observer != null) {
                observer.selected("LabourGroup", "LabourGroup");
            }
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            LabourGroupAutoCompleter completer = (LabourGroupAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isFocusable()) {
    ...
    public LabourGroup getObject() {
        return type;

    }

    public void setObject(LabourGroup type) {
        this.type = type;
        textComp.setText(type == null ? null : type.getLabourName());
    }
