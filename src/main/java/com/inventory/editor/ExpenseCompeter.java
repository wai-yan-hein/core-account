 ...
 * @author Lenovo
 */
public final class ExpenseCompeter implements KeyListener {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(ExpenseCompeter.class);
    ...
    public ExpenseCompeter() {
    }

    public ExpenseCompeter(JTextComponent comp, List<Expense> list,
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            expense = tableModel.getExpense(table.convertRowIndexToModel(
                    table.getSelectedRow()));
            textComp.setText(expense.getExpenseName());
            if (editor == null) {
            }
        }
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            ExpenseCompeter completer = (ExpenseCompeter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
    ...
    public Expense getStockUnit() {
        return expense;
    }

    public void setStockUnit(Expense expense) {
        this.expense = expense;
        this.textComp.setText(this.expense == null ? null : this.expense.getExpenseName());
    }
