 ...
 * @author Lenovo
 */
public class BrandAutoCompleter implements KeyListener {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(BrandAutoCompleter.class);
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            ...
            ((JTextField) textComp).setText(brand.getBrandName());
        }
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            BrandAutoCompleter completer = (BrandAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
    ...
    public void setBrand(StockBrand brand) {
        this.brand = brand;
        textComp.setText(brand == null ? null : brand.getBrandName());
    }
