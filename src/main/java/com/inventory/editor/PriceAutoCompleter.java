 ...
 * @author Lenovo
 */
public final class PriceAutoCompleter implements KeyListener {

    private final JTable table = new JTable();
    private final JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private final PriceTableModel priceTableModel = new PriceTableModel();
    ...
    public PriceAutoCompleter() {
    }

    public PriceAutoCompleter(JTextComponent comp, List<PriceOption> list,
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            PriceAutoCompleter completer = (PriceAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
