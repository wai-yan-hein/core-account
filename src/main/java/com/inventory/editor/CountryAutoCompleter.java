 ...
 * @author Lenovo
 */
public final class CountryAutoCompleter implements KeyListener {

    private final JTable table = new JTable();
    private final JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private final CountryTableModel countryTableModel = new CountryTableModel();
    ...
    public void setListCountry(List<Country> list) {
        if (filter) {
            Country sm = new Country("0", "All");
            list.add(0, sm);
            setCountry(sm);
        }
        countryTableModel.setListCountry(list);
        if (!list.isEmpty()) {
            table.setRowSelectionInterval(0, 0);
        }
    }

    public CountryAutoCompleter() {
    }

    public CountryAutoCompleter(JTextComponent comp,
        ...
        table.setModel(countryTableModel);
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            country = countryTableModel.getCountry(table.convertRowIndexToModel(
                    table.getSelectedRow()));
            textComp.setText(country.getCountryName());
            if (editor == null) {
                if (observer != null) {
                    observer.selected("CountryList", country.getCode());
                }
            }
        }
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            CountryAutoCompleter completer = (CountryAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
    ...
    public void setCountry(Country country) {
        ...
        this.textComp.setText(this.country == null ? null : this.country.getCountryName());
    }
