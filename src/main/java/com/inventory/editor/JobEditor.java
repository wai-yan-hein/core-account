 ...
 * @author Lenovo
 */
public class JobEditor extends AbstractCellEditor implements TableCellEditor {

    private JComponent component = null;
    private JobAutoCompleter completer;
    private List<Job> listData;

    public JobEditor(List<Job> listData) {
    ...
    public java.awt.Component getTableCellEditorComponent(JTable table, Object value,
        ...
        completer = new JobAutoCompleter(jtf, this, false);
