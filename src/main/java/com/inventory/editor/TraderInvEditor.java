 ...
 * @author Lenovo
 */
public class TraderInvEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public TraderInvEditor(InventoryRepo inventoryRepo, String traderType) {
        this.inventoryRepo = inventoryRepo;
        this.traderType = traderType;
    }

    public TraderInvEditor() {
    }
    ...
    public java.awt.Component getTableCellEditorComponent(JTable table, Object value,
        ...
        completer = new TraderAutoCompleter(jtf, inventoryRepo, this, false, traderType);
        return component;
    }
    ...
    public Object getCellEditorValue() {
        Object obj;
        Trader dto = completer.getTrader();
