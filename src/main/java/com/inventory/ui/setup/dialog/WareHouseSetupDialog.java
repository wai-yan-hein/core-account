 ...
 */
@Slf4j
public class WareHouseSetupDialog extends javax.swing.JDialog implements KeyListener {
    ...
    private void sendMessage(String mes) {
        inventoryRepo.sendDownloadMessage(MessageType.WARE_HOUSE, mes)
                .doOnSuccess((t) -> {
                    log.info(t);
                }).subscribe();
    }
    ...
    private boolean isValidEntry() {
        ...
        if (txtName.getText().isEmpty()) {
            status = false;
            JOptionPane.showMessageDialog(this, "Invalid Ware House Name");
            txtName.requestFocus();
        } else {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ware House Name");
