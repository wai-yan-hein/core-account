 ...
 */
@Slf4j
public class StockCriteriaSetupDialog extends javax.swing.JDialog implements KeyListener {

    private int selectRow = - 1;
    private StockCriteria criteria = new StockCriteria();
    private final StockCriteriaTableModel criteriaTableModel = new StockCriteriaTableModel();
    ...
    public void setListStockCriteria(List<StockCriteria> listStockCriteria) {
        ...
        this.listStockCriteria = listStockCriteria;
     ...
     * @param frame
     */
    public StockCriteriaSetupDialog(JFrame frame) {
        super(frame, false);
        initComponents();
        initKeyListener();
    ...
    private void initKeyListener() {
        ...
        tblStockCriteria.addKeyListener(this);
    }

    private void initTable() {
        tblStockCriteria.setModel(criteriaTableModel);
        sorter = new TableRowSorter<>(tblStockCriteria.getModel());
        tblStockCriteria.setRowSorter(sorter);
        tblStockCriteria.getTableHeader().setFont(Global.lableFont);
        tblStockCriteria.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        tblStockCriteria.setDefaultRenderer(Object.class, new TableCellRender());
        tblStockCriteria.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
            if (e.getValueIsAdjusting()) {
                if (tblStockCriteria.getSelectedRow() >= 0) {
                    selectRow = tblStockCriteria.convertRowIndexToModel(tblStockCriteria.getSelectedRow());
                    setStockCriteria(criteriaTableModel.getObject(selectRow));
                }
            }
        });
        tblStockCriteria.setRowHeight(Global.tblRowHeight);
        tblStockCriteria.setDefaultRenderer(Object.class, new TableCellRender());

    }

    private void setStockCriteria(StockCriteria cat) {
        criteria = cat;
    ...
    private void clear() {
        ...
        criteriaTableModel.refresh();
        tblStockCriteria.requestFocus();
        txtUserCode.requestFocus();
        progress.setIndeterminate(false);
        btnSave.setEnabled(true);
    }
    ...
    private boolean isValidEntry() {
        ...
        if (txtName.getText().isEmpty()) {
            ...
            if (lblStatus.getText().equals("NEW")) {
                ...
                criteria.setKey(key);
                criteria.setCreatedBy(Global.loginUser.getUserCode());
    ...
    private void initComponents() {
        ...
        tblStockCriteria = new javax.swing.JTable();
        ...
        tblStockCriteria.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblStockCriteria.setName("tblStockCriteria"); // NOI18N
        jScrollPane1.setViewportView(tblStockCriteria);
    ...
    private javax.swing.JTable tblStockCriteria;
