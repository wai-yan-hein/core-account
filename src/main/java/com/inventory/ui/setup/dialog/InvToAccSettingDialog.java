...
public class InvToAccSettingDialog extends javax.swing.JDialog {
    ...
    public void initMain() {
        ...
        model.setListSetting(Global.listAccSetting);
    ...
    private void select() {
        if (tblSetting.getSelectedRow() >= 0) {
            ...
            txtDiscount.setText(setting.getDisAccount());
            txtPayment.setText(setting.getPayAccount());
            txtTax.setText(setting.getTaxAccount());
            txtDep.setText(setting.getDepartment());
            txtSource.setText(setting.getSoureAccount());
            txtBal.setText(setting.getBalAccount());
        } else {
    ...
    private void save() {
        if (tblSetting.getSelectedRow() >= 0) {
            int row = tblSetting.convertRowIndexToModel(tblSetting.getSelectedRow());
            AccSetting setting = model.getSetting(row);
            setting.setDisAccount(txtDiscount.getText());
            setting.setPayAccount(txtPayment.getText());
            setting.setTaxAccount(txtTax.getText());
            setting.setDepartment(txtDep.getText());
            setting.setSoureAccount(txtSource.getText());
            setting.setBalAccount(txtBal.getText());
