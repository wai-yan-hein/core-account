 ...
 */
@Slf4j
public class StockPaymentBagTableModel extends AbstractTableModel {
    ...
    private final String[] columnNames = {"Date", "Vou No", "Contract No", "Remark",
        "Reference", "Stock Code", "Stock Name", "Bag", "Balance Bag", "Issue Bag",
        "Single Issue"};
    ...
    public StockPaymentBagTableModel() {
    }
        ...
        try {
            ...
            return switch (column) {
                ...
                case 6 ->
                    b.getStockName();
                case 7 ->
                    Util1.toNull(b.getBag());
                case 8 ->
                    Util1.toNull(b.getBalBag());
                case 9 ->
                    Util1.toNull(b.getPayBag());
                case 10 ->
                    b.isFullPaid();
                default ->
                    null;
            ...
            if (value != null) {
                ...
                switch (column) {
                    case 9 -> {
                        ...
                        double out = Util1.getDouble(obj.getBalBag());
                        obj.setPayBag(qty);
                    ...
                    case 10 -> {
                        if (value instanceof Boolean paid) {
                            ...
                            obj.setPayBag(paid ? obj.getBalBag() : 0.0);
                        }
                    }
                }
