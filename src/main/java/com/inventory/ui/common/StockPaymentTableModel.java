 ...
 */
@Slf4j
public class StockPaymentTableModel extends AbstractTableModel {

    private List<PaymentHisDetail> listDetail = new ArrayList<>();
    private List<PaymentHisDetailKey> listDelete = new ArrayList<>();
    private final String[] columnNames = {"Date", "Vou No", "Remark", "Reference", "Qty", "Outstanding", "Issue", "Single Issue"};
