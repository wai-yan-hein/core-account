...
import com.inventory.model.MilingHisKey;
...
public class MilingEntry extends javax.swing.JPanel implements SelectionObserver, KeyListener, KeyPropagate, PanelControl {
    ...
    private List<MilingOutDetail> listOutDetail = new ArrayList();
...
//    private RiceMilingHisHistoryDialog dialog;
    ...
    private MilingHis saleHis = new MilingHis();
...
//                    });
    ...
    private void initSaleTable() {
        ...
        tblRaw.getColumnModel().getColumn(1).setPreferredWidth(450);//Name
        tblRaw.getColumnModel().getColumn(2).setPreferredWidth(60);//Rel
        tblRaw.getColumnModel().getColumn(3).setPreferredWidth(60);//Location
        tblRaw.getColumnModel().getColumn(4).setPreferredWidth(50);//weight
        tblRaw.getColumnModel().getColumn(5).setPreferredWidth(30);//unit
        tblRaw.getColumnModel().getColumn(6).setPreferredWidth(50);//qty
        tblRaw.getColumnModel().getColumn(7).setPreferredWidth(30);//unit
        tblRaw.getColumnModel().getColumn(8).setPreferredWidth(50);//std
        tblRaw.getColumnModel().getColumn(9).setPreferredWidth(50);//total
        tblRaw.getColumnModel().getColumn(10).setPreferredWidth(50);//price
        tblRaw.getColumnModel().getColumn(11).setPreferredWidth(60);//amt
        ...
        monoLoc.subscribe((t) -> {
            tblRaw.getColumnModel().getColumn(3).setCellEditor(new LocationCellEditor(t));
        });
        tblRaw.getColumnModel().getColumn(4).setCellEditor(new AutoClearEditor());//weight
        tblRaw.getColumnModel().getColumn(6).setCellEditor(new AutoClearEditor());//qty
        ...
        if (ProUtil.isSalePriceChange()) {
            if (ProUtil.isPriceOption()) {
                tblRaw.getColumnModel().getColumn(10).setCellEditor(new SalePriceCellEditor(inventoryRepo));//price
            } else {
                tblRaw.getColumnModel().getColumn(10).setCellEditor(new AutoClearEditor());//price
            }
        ...
        milingOutTableModel.setModel(totWeight);
        ...
        tblOutput.getColumnModel().getColumn(1).setPreferredWidth(450);//Name
        tblOutput.getColumnModel().getColumn(2).setPreferredWidth(60);//Rel
        tblOutput.getColumnModel().getColumn(3).setPreferredWidth(60);//Location
        tblOutput.getColumnModel().getColumn(4).setPreferredWidth(50);//weight
        tblOutput.getColumnModel().getColumn(5).setPreferredWidth(30);//unit
        tblOutput.getColumnModel().getColumn(6).setPreferredWidth(50);//qty
        tblOutput.getColumnModel().getColumn(7).setPreferredWidth(30);//unit
        tblOutput.getColumnModel().getColumn(8).setPreferredWidth(50);//std
        tblOutput.getColumnModel().getColumn(9).setPreferredWidth(50);//total
        tblOutput.getColumnModel().getColumn(10).setPreferredWidth(50);//percent
        tblOutput.getColumnModel().getColumn(11).setPreferredWidth(50);//price
        tblOutput.getColumnModel().getColumn(12).setPreferredWidth(60);//amt
        ...
        monoLoc.subscribe((t) -> {
            tblOutput.getColumnModel().getColumn(3).setCellEditor(new LocationCellEditor(t));
        });
        tblOutput.getColumnModel().getColumn(4).setCellEditor(new AutoClearEditor());//weight
        tblOutput.getColumnModel().getColumn(6).setCellEditor(new AutoClearEditor());//qty
        inventoryRepo.getStockUnit().subscribe((t) -> {
        ...
        if (ProUtil.isSalePriceChange()) {
            if (ProUtil.isPriceOption()) {
                tblOutput.getColumnModel().getColumn(11).setCellEditor(new SalePriceCellEditor(inventoryRepo));//price
            } else {
                tblOutput.getColumnModel().getColumn(11).setCellEditor(new AutoClearEditor());//price
            }
    ...
    private void clear() {
        ...
        txtCus.requestFocus();
        projectAutoCompleter.setProject(null);
        totQty.setValue(null);
        totWeight.setValue(null);
        totAmount.setValue(null);
        totOutputQty.setValue(null);
        totOutputWeight.setValue(null);
        totOutputAmount.setValue(null);
    }
...
//            saleHis.setListSH(riceMilingTableModel.getListDetail());
//            saleHis.setListDel(riceMilingTableModel.getDelList());
//            saleHis.setBackup(riceMilingTableModel.isChange());
...
//            });
    ...
    private boolean isValidEntry() {
        ...
        if (lblStatus.getText().equals("DELETED")) {
            ...
            status = false;
            txtLocation.requestFocus();
        } else if (Util1.getFloat(totOutputAmount.getValue()) <= 0) {
            ...
            if (lblStatus.getText().equals("NEW")) {
                MilingHisKey key = new MilingHisKey();
...
//                    });
    ...
    private void calculateTotalAmount(boolean partial) {
        ...
        totalQty = listDetail.stream().map(s -> Util1.getFloat(s.getQty())).reduce(totalQty, (accumulator, _item) -> accumulator + _item);
        totalWeight = listDetail.stream().map(d -> Util1.getFloat(d.getTotalWeight())).reduce(totalWeight, (accumulator, _item) -> accumulator + _item);
        ...
        totQty.setValue(totalQty);
        totWeight.setValue(totalWeight);
        totAmount.setValue(totalAmount);
    }

    private void calculateTotalAmountForOutput(boolean partial) {
        float totalAmount = 0.0f;
        float totalQty = 0.0f;
        float totalWeight = 0.0f;
        float totalOutputAmount = 0.0f;

        // calculate price
        totalAmount = Util1.getFloat(totAmount.getValue());
        listOutDetail = milingOutTableModel.getListDetail();
        listOutDetail.get(0).setPrice(0.0f);
        listOutDetail.get(0).setAmount(0.0f);
        totalOutputAmount = listOutDetail.stream().map(sdh -> Util1.getFloat(sdh.getAmount())).reduce(totalOutputAmount, (accumulator, _item) -> accumulator + _item);
        listOutDetail.get(0).setAmount(totalAmount - totalOutputAmount);
        ...
        //calculate total
        totalOutputAmount = 0.0f;
        milingOutTableModel.setListDetail(listOutDetail);
        listOutDetail = milingOutTableModel.getListDetail();
        totalOutputAmount = listOutDetail.stream().map(sdh -> Util1.getFloat(sdh.getAmount())).reduce(totalOutputAmount, (accumulator, _item) -> accumulator + _item);
        totalQty = listOutDetail.stream().map(s -> Util1.getFloat(s.getQty())).reduce(totalQty, (accumulator, _item) -> accumulator + _item);
        totalWeight = listOutDetail.stream().map(d -> Util1.getFloat(d.getTotalWeight())).reduce(totalWeight, (accumulator, _item) -> accumulator + _item);
        totOutputQty.setValue(totalQty);
        totOutputWeight.setValue(totalWeight);
        totOutputAmount.setValue(totalOutputAmount);
    }
...
//        dialog.search();
    ...
    public void setSaleVoucher(MilingHis sh) {
        if (sh != null) {
            progress.setIndeterminate(true);
            saleHis = sh;
...
//        }
    ...
    private void initComponents() {
        ...
        totWeight = new javax.swing.JFormattedTextField();
        ...
        totOutputAmount = new javax.swing.JFormattedTextField();
        totOutputWeight = new javax.swing.JFormattedTextField();
        totOutputQty = new javax.swing.JFormattedTextField();
        ...
        panelSaleLayout.setHorizontalGroup(
            ...
            .addGroup(panelSaleLayout.createSequentialGroup()
                ...
                .addGroup(panelSaleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCus)
                    .addComponent(txtSaleDate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelSaleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtRemark, javax.swing.GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
                ...
                .addGroup(panelSaleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtDueDate, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                    .addComponent(txtCurrency)
                    .addComponent(txtReference))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel10)
                .addGap(14, 14, 14)
                .addComponent(txtProjectNo, javax.swing.GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        totQty.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                totQtyActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(totQty, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
                    .addComponent(totWeight))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(totOutputQty, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
                    .addComponent(totOutputWeight, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(totOutputAmount))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(totOutputQty, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(totOutputWeight, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(totOutputAmount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void totQtyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_totQtyActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_totQtyActionPerformed
    ...
    public void selected(Object source, Object selectObj) {
        switch (source.toString()) {
            ...
            case "SALE-TOTAL" ->
                calculateTotalAmount(false);
            case "SALE-TOTAL-OUT" ->
                calculateTotalAmountForOutput(false);
            case "Location" ->
                setAllLocation();
            case "SALE-HISTORY" -> {
...
//                    });
    ...
    private javax.swing.JFormattedTextField totOutputAmount;
    private javax.swing.JFormattedTextField totOutputQty;
    private javax.swing.JFormattedTextField totOutputWeight;
    private javax.swing.JFormattedTextField totQty;
    private javax.swing.JFormattedTextField totWeight;
