        ...
        if (row >= 0) {
            ...
            if (isValidReport(reportUrl)) {
                if (!isReport) {
                    ...
                    param.put("p_stock_name", stockAutoCompleter.getStock().getStockName());
                    param.put("p_stock_type", stockTypeAutoCompleter.getStockType().getStockTypeName());
                    param.put("p_category", categoryAutoCompleter.getCategory().getCatName());
                    param.put("p_brand", brandAutoCompleter.getBrand().getBrandName());
                    param.put("p_warehouse", wareHouseAutoCompleter.getObject().getDescription());
                    param.put("p_location", locationAutoCompleter.getLocation().getLocName());
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtToDate, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
