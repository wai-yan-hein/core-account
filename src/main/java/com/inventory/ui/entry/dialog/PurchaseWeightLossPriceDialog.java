 ...
 */
@Slf4j
public class PurchaseWeightLossPriceDialog extends javax.swing.JDialog {

    private InventoryRepo inventoryRepo;
    private boolean confirm = false;
    private PurHisDetail sd;
     ...
     * @param frame
     */
    public PurchaseWeightLossPriceDialog(JFrame frame) {
        super(frame, true);
        initComponents();
        initTextBox();
    }
    ...
    public void setPurDetail(PurHisDetail sd) {
        this.sd = sd;
    ...
    private void initComponents() {
        ...
        setTitle("Purchase Weight Loss Price");
