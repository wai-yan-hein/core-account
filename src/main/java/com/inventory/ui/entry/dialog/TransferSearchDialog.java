 ...
 */
@Slf4j
public class TransferSearchDialog extends javax.swing.JDialog implements KeyListener {
    ...
    public TransferSearchDialog(JFrame frame) {
        super(frame, true);
        initComponents();
        initKeyListener();
    }
    ...
    private void select() {
        ...
        if (row >= 0) {
            ...
            observer.selected("TR-HISTORY", his.getVouNo());
            setVisible(false);
        } else {
