...
import com.user.common.MachinePropertyTableModel;
 ...
 */
@Component
public class MachinePropertySetup extends javax.swing.JPanel {

    @Autowired
    private WebClient userApi;
    @Autowired
    private UserRepo userRepo;
    private final MachinePropertyTableModel tableModel = new MachinePropertyTableModel();
    ...
    public void searchSysProperty() {
        Mono<ResponseEntity<List<MachineProperty>>> result = userApi.get()
                ...
                .build())
                .retrieve()
                .toEntityList(MachineProperty.class);
        result.subscribe((t) -> {
