 ...
 * @author Lenovo
 */
public final class CompanyAutoCompleter implements KeyListener {
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            company = companyTableModel.getCompany(table.convertRowIndexToModel(
                    table.getSelectedRow()));
            textComp.setText(company.getCompName());
        }
    ...
    private final Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            CompanyAutoCompleter completer = (CompanyAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                company = companyTableModel.getCompany(completer.table.convertRowIndexToModel(
                        completer.table.getSelectedRow()));
                completer.textComp.setText(company.getCompName());
            }
    ...
    public void setCompany(CompanyInfo company) {
        ...
        this.textComp.setText(this.company == null ? null : this.company.getCompName());
    }
