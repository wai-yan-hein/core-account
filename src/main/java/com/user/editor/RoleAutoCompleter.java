 ...
 * @author Lenovo
 */
public final class RoleAutoCompleter implements KeyListener {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(RoleAutoCompleter.class);
    private final JTable table = new JTable();
    private final JPopupMenu popup = new JPopupMenu();
    private final JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private final UserRoleTableModel userTableModel;
    ...
    public RoleAutoCompleter(JTextComponent comp, List<AppRole> list,
        ...
        userTableModel.setListRole(list);
        ...
        table.getColumnModel().getColumn(0).setPreferredWidth(10);//name
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            appRole = userTableModel.getRole(table.convertRowIndexToModel(
                    table.getSelectedRow()));
            textComp.setText(appRole.getRoleName());
        }
    ...
    private final Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            RoleAutoCompleter completer = (RoleAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                appRole = userTableModel.getRole(completer.table.convertRowIndexToModel(
                        completer.table.getSelectedRow()));
                completer.textComp.setText(appRole.getRoleName());
            }
    ...
    public void setAppRole(AppRole appRole) {
        ...
        this.textComp.setText(this.appRole == null ? null : this.appRole.getRoleName());
    }
