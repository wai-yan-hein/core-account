 ...
 * @author Lenovo
 */
public final class BusinessTypeAutoCompleter implements KeyListener {

    private final JTable table = new JTable();
    private final JPopupMenu popup = new JPopupMenu();
    private final JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private final BusinessTypeTableModel tableModel;
    private BusinessType object;
    public AbstractCellEditor editor;
    private final TableRowSorter<TableModel> sorter;
    private int x = 0;
    private int y = 0;

    public BusinessTypeAutoCompleter(JTextComponent comp, List<BusinessType> list,
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            ...
            textComp.setText(object.getBusName());
        }
    ...
    private final Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            BusinessTypeAutoCompleter completer = (BusinessTypeAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);

            if (completer.table.getSelectedRow() != -1) {
                object = tableModel.getObject(completer.table.convertRowIndexToModel(
                        completer.table.getSelectedRow()));
                completer.textComp.setText(object.getBusName());
            }
    ...
    public BusinessType getObject() {
        return object;
    }

    public void setObject(BusinessType object) {
        this.object = object;
        this.textComp.setText(this.object == null ? null : this.object.getBusName());
    }
