 ...
 */
@Slf4j
public class MenuTemplateTreeTrasnferHandler extends TransferHandler {
    ...
    public MenuTemplateTreeTrasnferHandler(UserRepo userRepo) {
    ...
    protected void exportDone(JComponent source, Transferable data, int action) {
        if ((action & MOVE) == MOVE) {
            try {
                MenuTemplate coaParent = (MenuTemplate) parent.getUserObject();
                Integer parentCode = coaParent.getKey().getMenuId();
                ...
                for (DefaultMutableTreeNode nodesToRemove1 : nodesToRemove) {
                    ...
                    MenuTemplate coa = (MenuTemplate) nodesToRemove1.getUserObject();
                    coa.setParentMenuId(parentCode);
                    saveMenu(coa);
                }
            } catch (Exception e) {
    ...
    private void saveMenu(MenuTemplate menu) {
