 ...
 */
@Slf4j
public class SBWeightDetailTableModel extends AbstractTableModel {

    private List<ClosingBalance> listDetail = new ArrayList();
    private final String[] columnNames = {"Date", "Vou No", "Remark", "Op-Qty", "Op-Weight",
        "Pur-Qty", "Pur-Wt", "In-Qty", "In-Weight", "Sale-Qty", "Sale-Weight", "Out-Qty", "Out-Weight", "Closing-Qty", "Closing-Weight"};
