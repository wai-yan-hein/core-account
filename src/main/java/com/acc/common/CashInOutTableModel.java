 ...
 * @author wai yan
 */
public class CashInOutTableModel extends AbstractTableModel {

    private static final Logger log = LoggerFactory.getLogger(CashInOutTableModel.class);
    private List<Gl> listVGl = new ArrayList();
    private String[] columnNames = {"Currency", "Cash In", "Cash Out"};
