...
public class PaginatedTableDecorator<T> {
    ...
    private AllCashTableModel objectTableModel;
    private static final int MaxPagingCompToShow = 9;
    private static final String Ellipses = "...";

    public PaginationDataProvider<T> getDataProvider() {
        return dataProvider;
    }
    ...
    private PaginatedTableDecorator(JPanel contentPanel, JTable table,
    ...
    public static <T> PaginatedTableDecorator<T> decorate(JPanel contentPanel, JTable table,
            PaginationDataProvider<T> dataProvider, int[] pageSizes, int defaultPageSize) {
        PaginatedTableDecorator<T> decorator = new PaginatedTableDecorator<>(contentPanel, table, dataProvider,
    ...
    private void initDataModel() {
        ...
        objectTableModel = (AllCashTableModel) model;
    }
