 ...
 * @author Lenovo
 */
public final class TranSourceAutoCompleter implements KeyListener {
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            TranSourceAutoCompleter completer = (TranSourceAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
